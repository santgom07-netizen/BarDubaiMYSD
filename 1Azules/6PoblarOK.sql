...
VALUES (6001, 'Cena corporativa', 'Reserva empresa ACME',
        DATE '2025-11-10', 19, 22, 10, 'Programado');

-- EVALUACION (cliente 1 evalúa la venta 4001)
...
VALUES (8001, 1, 5, 4, 5, 'Excelente atención y comida',
        DATE '2025-11-03');

-- TURNO (para empleados 100 y 101)
INSERT INTO Turno (idTurno, idEmpleado, tipo, horaInicio, horaFin,
                   fecha, asistio, observaciones)
VALUES (9001, 100, 'Mañana', 8, 16, DATE '2025-11-02', 1, 'Sin novedades');

INSERT INTO Turno (idTurno, idEmpleado, tipo, horaInicio, horaFin,
                   fecha, asistio, observaciones)
VALUES (9002, 101, 'Noche', 16, 24, DATE '2025-11-02', 1, 'Cubrió evento');

-- RECETA (para el producto 201 - Pasta Alfredo)
INSERT INTO Receta (idReceta, idProducto, ingredientes, instrucciones,
                    tiempoPreparacion, porciones)
VALUES (10001, 201,
        'Pasta, crema de leche, queso parmesano, mantequilla, ajo',
        'Cocer la pasta, preparar salsa Alfredo y mezclar todo',
        20, 2);
