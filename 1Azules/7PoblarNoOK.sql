...
-- 1) PK duplicada en Evento (idEvento ya existe)
INSERT INTO Evento (idEvento, nombreEvento, descripcion, fechaEvento,
                    horaInicio, horaFin, numeroPersonas, estado)
VALUES (6001, 'Evento duplicado', 'PK repetida',
        DATE '2025-11-11', 18, 20, 5, 'Programado');

-- 2) Tipo / CHECK inválido: numeroPersonas <= 0
INSERT INTO Evento (idEvento, nombreEvento, descripcion, fechaEvento,
                    horaInicio, horaFin, numeroPersonas, estado)
VALUES (6002, 'Personas negativas', 'No permitido',
        DATE '2025-11-12', 18, 20, 0, 'Programado');

-- 3) FK inexistente en Evento (idCliente que no existe en Cliente)
INSERT INTO Evento (idEvento, nombreEvento, descripcion, fechaEvento,
                    horaInicio, horaFin, numeroPersonas, estado, idCliente)
VALUES (6003, 'Cliente fantasma', 'FK cliente',
        DATE '2025-11-13', 18, 20, 4, 'Programado', 9999);


-- 4) PK duplicada en Evaluacion
INSERT INTO Evaluacion (idEvaluacion, idCliente, calificacionServicio,
                        calificacionProducto, calificacionAmbiente,
                        comentario, fechaEvaluacion)
VALUES (8001, 1, 5, 5, 5, 'PK repetida', DATE '2025-11-04');

-- 5) CHECK fuera de rango en Evaluacion (calificación > 5)
INSERT INTO Evaluacion (idEvaluacion, idCliente, calificacionServicio,
                        calificacionProducto, calificacionAmbiente,
                        comentario, fechaEvaluacion)
VALUES (8002, 1, 6, 4, 5, 'Servicio 6/5', DATE '2025-11-05');

-- 6) FK inexistente en Evaluacion (idCliente que no existe)
INSERT INTO Evaluacion (idEvaluacion, idCliente, calificacionServicio,
                        calificacionProducto, calificacionAmbiente,
                        comentario, fechaEvaluacion)
VALUES (8003, 9999, 4, 4, 4, 'Cliente fantasma', DATE '2025-11-06');


-- 7) PK duplicada en Turno
INSERT INTO Turno (idTurno, idEmpleado, tipo, horaInicio, horaFin,
                   fecha, asistio, observaciones)
VALUES (9001, 100, 'Mañana', 8, 16, DATE '2025-11-03', 1, 'PK repetida');

-- 8) CHECK binario inválido en Turno (asistio distinto de 0/1)
INSERT INTO Turno (idTurno, idEmpleado, tipo, horaInicio, horaFin,
