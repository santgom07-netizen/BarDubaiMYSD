...
-- Eliminar vistas
DROP VIEW v_eventos_cliente;
DROP VIEW v_turnos_empleado;
DROP VIEW v_evaluaciones_cliente;
DROP VIEW v_recetas_producto;

-- Eliminar índices
DROP INDEX ix_evento_idcliente;
DROP INDEX ix_evento_fecha;

DROP INDEX ix_evaluacion_idcliente;

DROP INDEX ix_turno_idempleado;
DROP INDEX ix_turno_fecha;

DROP INDEX ix_receta_idproducto;
